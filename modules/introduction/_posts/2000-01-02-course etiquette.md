...
Online courses can be difficult to navigate socially at times, so the following guide is what is widely considered good etiquette to follow on the [discussion forum](https://www.edudialogue.org/forum/) during the live cohorts of the course (note that the discussion forum is not active outside of the live cohorts):
